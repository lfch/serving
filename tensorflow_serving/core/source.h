...
class Source {
 public:
  ...
  /// (given by 'servable_name'). All versions supplied in a call must be for
  /// the servable identified in 'servable_name'. Invocations on different
  ...
  /// subsequently omitted from a second invocation, the implication of omitting
